var boxCollision = function({m1,m2,x1,x2,v1,v2},draw){
    ...
    var getPosition = function(t){
        if(n.t < t && !terminated){//cache too old, need to renew
            dataCache.old = dataCacje.new;
        ...
        var o = dataCache.old;
        var n = dataCache.new;
        xt1 = o.x1+(t-o.t)/(n.t-o.t)*(n.x1-o.x1);
        xt2 = o.x2+(t-o.t)/(n.t-o.t)*(n.x2-o.x2);
        return [xt1,xt2];
    }
...
//document.getElementById("display").innerHTML = "pi = "+cnt/1000;
